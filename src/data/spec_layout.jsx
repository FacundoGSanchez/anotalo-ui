...
// Breakpoint: 768px (window.innerWidth < 768 → mobile)
...
export const LAYOUT_SPEC = {
  desktop: {
    sidebar: {
      ...
      profile: false, // CardUser eliminado del sidebar, movido a navbar
    },
  ...
  mobile: {
    ...
    menumorepage: {
      ...
      route: "/more",
      /* Look & Feel: replica exactamente el sidebar del desktop */
      ...
      menu: {
        ...
        mode: "inline",
        theme: "dark",
        /* Reutiliza los estilos globales de .ant-menu-dark del sidebar */
        sections: [
          "Inicio (standalone, HomeOutlined, ruta /)",
