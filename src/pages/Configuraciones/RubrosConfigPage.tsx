...
import type { Rubro as OrgRubro } from "@/types/organization";
...
const RubrosConfigPage = () => {
  ...
  const [rubros, setRubros] = useState<OrgRubro[]>([]);
  const [modalOpen, setModalOpen] = useState(false);
  const [editItem, setEditItem] = useState<OrgRubro | null>(null);
