...
const BOTONES_TECLADO: readonly string[] = [
  "1",
  "2",
  "3",
  "4",
...
interface CalculadoraGestionProps {
  value: number;
...
const CalculadoraGestion = ({
  ...
  const handleDesktopChange = (val: number | null) => {
    onChange(val || 0);
  };
