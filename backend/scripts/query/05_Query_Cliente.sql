...
BEGIN
    ...
    DECLARE cur CURSOR FOR
        SELECT Id, Nro, Nombre, Telefono, Activo, Saldo,
               CtaCteHabilitado, CtaCteImporteMaximo, CtaCtePlazoDias, FechaRegistro
        FROM Cliente
    ...
    OPEN cur;
    read_loop: LOOP
        FETCH cur INTO v_id, v_nro, v_nombre, v_telefono, v_activo, v_saldo,
                       v_ctaCteHabilitado, v_ctaCteImporteMaximo, v_ctaCtePlazoDias, v_fecha;
        IF v_done THEN
            LEAVE read_loop;
        END IF;
